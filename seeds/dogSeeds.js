      ...
      return knex('dog_table').insert([
        {
          ...
          special_requirements: '"Enjoys going on adventures with you, especially if your name is Fin."',
        ...
        },
        {
          ...
          good_with_other_dogs: 'Yes',
          special_requirements: '"Enjoys long walks on the beach and loves to spend most nights watching movies on the T.V."',
        ...
        },
        {
          ...
          special_requirements: '"Out-going and easy to get along with. Loves to go for runs on beautiful days."',
        ...
        },
        {
          ...
          good_with_other_dogs: 'Yes',  
          special_requirements: '"Loves to contemplate life by staring out of her window."',
